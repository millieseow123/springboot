...
import { CalendarEventTimesChangedEvent, CalendarEventTimesChangedEventType } from 'angular-calendar/modules/common/calendar-event-times-changed-event.interface';
...
export class ScheduleComponent   implements OnChanges, OnInit, OnDestroy
{
  /**
  ...
  weekendDays!: number[];
    ...
    * @hidden
    */
   openDay: MonthViewDay | undefined;
